...
for n in range(i):#Modificar para este caso, pero no me acuerdo para que valor corresponde cada tráfico
    B_2_salto[0][n] = 1 - ((1 - B_1_salto[0][n])*(1 - B_1_salto[0][n]))
    B_2_salto[1][n] = 1 - ((1 - B_1_salto[0][n])*(1 - B_1_salto[1][n]))
